...
def labeling(save, rank_method, f):
    ...
    for raw_request_line in raw_requests_dataset:
        ...
        if n_try % 50 == 0:
            print("{} rank_method {} packets {} overmax {} fail, Avg Time {:.3f}, Total Time : {:.3f}".format(rank_method, n_packet, n_overmax, n_fail, avg_time, total_time))
    ...
    if save == True:
        ...
        f.close()
        target_dir = '../data/sfc_labeling_'+method_str+'.csv'
